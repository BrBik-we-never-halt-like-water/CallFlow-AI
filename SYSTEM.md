...
| `test_safety.py`               | 29    | E.164, masking, gate decisions, `resolve_safety_settings()`, and (it-15) `apply_run_override()`'s tighten-only per-run ceiling/allowlist merge                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `test_orchestrator.py`         | 42    | Goal rendering, the async dial pipeline, ceiling + suppression gating, extraction shapes, transcript/poll-resilience edge cases, and (it-14) idempotency-key stability, `_calls_made` counting an attempt rather than only a confirmed success, and `should_cancel` stopping `run()` between contacts - `ISSUES.md` #54, #57                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
