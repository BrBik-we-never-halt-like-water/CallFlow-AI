...
export const VERTICALS: Vertical[] = [
  {
    ...
    headline:
      'Screen a shortlist overnight, interview only the ones worth interviewing.',
...
If at any point they sound frustrated, ask to speak to a person, or ask you to stop, stop screening immediately, apologise once, and hand off.`,
    schema: [
      ...
      },
      {
        ...
        type: 'string',
        description:
          "Expected salary in the candidate's own words, including currency.",
      },
      {
        key: 'location_fit',
        type: 'enum',
      ...
      },
      {
        ...
        type: 'string',
        description:
          'Any question the candidate asked that needs a human answer.',
      },
    ],
    objections: [
      {
      ...
      {
        question:
          "What happens when a candidate asks something the agent can't answer?",
        answer:
  ...
  },
  {
    ...
    headline:
      'Fill the slots that went quiet, without a receptionist on the phone all afternoon.',
...
If they sound distressed or frustrated, or ask for a person, stop and hand off to a human immediately.`,
    schema: [
      {
        ...
        type: 'boolean',
        description:
          'True if the contact accepted one of the offered openings.',
      },
      {
        key: 'slot_accepted',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        description:
          'Days and times that suit them, when no offered slot worked.',
      },
      {
      ...
      },
      {
        ...
        type: 'boolean',
        description:
          'True if anything clinical came up and needs a practice callback.',
      },
    ],
    objections: [
      {
  ...
  },
  {
    ...
    headline:
      'Reach every enquiry once, properly, before they enrol somewhere else.',
...
If they sound frustrated, ask for a person, or ask not to be called again, stop and hand off.`,
    schema: [
      ...
      },
      {
        ...
        type: 'boolean',
        description:
          'True if they asked about fees, scholarships, or eligibility.',
      },
      {
...
If they ask to speak to a person, ask not to be called again, or sound annoyed, stop qualifying and hand off immediately.`,
    schema: [
      {
        ...
        type: 'string',
        description:
          "The problem that prompted the enquiry, in the lead's words.",
      },
      {
        key: 'volume',
        type: 'string',
    ...
    objections: [
      ...
      {
        question:
          'How do we know the qualification is honest and not just optimistic?',
        answer:
