      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,480px)] lg:gap-16">
        <div className="flex flex-col gap-6">
          ...
          <p className="measure text-body-l text-text-dim">
            Not a slide deck. We open the product, load contacts you brought,
            and run a few of them for real, right there, before you decide
            anything.
          </p>
            ...
            {WHAT_HAPPENS.map((item, i) => (
              <li key={item.title} className="flex gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <h2 className="text-h4 font-medium text-text">
                    {item.title}
                  </h2>
          ...
          <div className="mt-2 flex flex-col gap-3 border-t border-rule pt-6">
            ...
            <p className="measure text-small text-text-dim">
              A run you can log back into, and a campaign already configured for
              your use case. If it is not a fit, we will say so on the call
              rather than email you for three weeks.
            </p>
          </div>
        </div>
