      ...
      <div className="flex flex-col gap-2">
        ...
        <Panel className="p-5">
          <p className="text-small text-text-dim">
            No incidents recorded. This page checks the service live rather than
            reading a status feed, so it reflects the moment you loaded it.
          </p>
        </Panel>
      </div>
    </div>
...
function Row({
  ...
  return (
    <div className="flex flex-wrap items-start justify-between gap-3 p-4">
      ...
      <span className="shrink-0 font-mono text-data tabular-nums text-text-dim">
        {value}
      </span>
    </div>
  );
