...
model. This matters architecturally: CALL-E is one calling _provider_, not infrastructure you
...
| `recipient_result_schema`  | object | JSON Schema for _per-recipient_ extraction - **not currently used by this codebase**, worth adopting for multi-recipient runs |
...
**Bottom line for CallFlow AI's architecture:** CALL-E is a great _voice-provider adapter_
