...
export function FirstRunChecklist({ hasCampaigns }: { hasCampaigns: boolean }) {
  ...
  const steps = [
    ...
    {
      id: "dry-run",
      title: "Run it in dry mode",
      body: "Walks the whole pipeline and shows you a real typed result. Nothing is dialled and no credits are spent.",
      cta: "Start a dry run",
      href: "/app/runs/new",
    },
  ];
    ...
    <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,320px)]">
      <Panel className="flex flex-col gap-5 p-5 sm:p-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="measure text-body text-text-dim">
            Three steps, about five minutes, and none of them place a call. The last one
            ends with a real typed result in front of you.
          </p>
        </div>
      ...
      <Panel sunken className="flex flex-col gap-4 p-5">
        ...
        <p className="text-small text-text-mute">
          In a dry run they light ice, because ice means simulated.
        </p>
