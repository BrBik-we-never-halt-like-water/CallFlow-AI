...
import { Archivo, IBM_Plex_Sans, Inter_Tight, JetBrains_Mono } from "next/font/google";
...
/**
 * Docs-only face. Scoped to `/docs` via `.docs-face` (see globals.css) rather
 * than replacing `--font-sans`   the rest of the site keeps Inter Tight.
 */
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${archivo.variable} ${interTight.variable} ${jetbrainsMono.variable} ${ibmPlexSans.variable}`}
    >
